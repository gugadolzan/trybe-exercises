...
describe('Busca um livro pelo ID', () => {
  describe('retorna um registro de livro', () => {
    ...
    before(async () => {
      ...
      result = await chai.request(app).get('/books/1');
    });
...
describe('Cria um novo livro', () => {
  describe('retorna o registro do livro criado', () => {
    ...
    before(async () => {
      ...
      result = await chai.request(app).post('/books').send(testBook);
    });
...
describe.skip('Atualiza um novo livro', () => {
  describe('retorna o registro do livro registrado', () => {
    ...
    before(async () => {
      ...
      result = await chai.request(app).post('/books/2').send({
