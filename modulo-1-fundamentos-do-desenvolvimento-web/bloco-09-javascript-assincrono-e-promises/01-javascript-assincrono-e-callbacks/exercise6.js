...
const sendMarsTemperature = (onSuccess, onFailure) => {
  setTimeout(() => {
    if (Math.random() <= 0.6) {
      const temperatue = getMarsTemperature();
      onSuccess(temperatue);
    } else {
...
// Prints "It is currently 47ºF at Mars", por exemplo, ou "Error getting temperature: Robot is busy"
sendMarsTemperature(temperatureInFahrenheit, handleError);

// Prints "Hi there! Curiosity here. Right now is 53ºC at Mars", por exemplo, ou "Error getting temperature: Robot is busy"
